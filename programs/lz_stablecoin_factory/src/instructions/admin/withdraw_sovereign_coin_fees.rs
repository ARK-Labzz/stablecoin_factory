...
#[derive(Accounts)]
pub struct WithdrawFromSovereignCoinProtocolVault<'info> {
    #[account(
        seeds = [b"factory"],
        bump = factory.bump,
    )]
...
pub fn handle_withdraw_from_sovereign_coin_account(
    ...
    transfer_checked(
        CpiContext::new_with_signer(
            ...
            TransferChecked {
                from: ctx.accounts.sovereign_coin_protocol_vault.to_account_info(),
