...
pub struct InitSovereignCoin<'info> {
    ...
    #[account(
        ...
        seeds = [b"sovereign_coin", factory.key().as_ref(), args.symbol.as_bytes()],
        bump
    )]
...
impl InitSovereignCoin<'_> {
    ...
    pub fn handler(ctx: Context<Self>, args: SovereignCoinArgs) -> Result<()> {
        ...
        sovereign_coin.creator = ctx.accounts.creator.key();
       ...
       // Set the name and symbol
        ...
        sovereign_coin.uri = vec![0u8; 200];
       ...
       // Set the fiat currency
        ...
        // Initialize bond account and usdc account 
        sovereign_coin.bond_holding = Pubkey::default();
        ...
        sovereign_coin.required_reserve_percentage = calculate_required_reserve(
            ctx.accounts.factory.min_usdc_reserve_percentage,
        ...
        emit_cpi!(SovereignCoinInitializedEvent {
            ...
            fiat_amount: sovereign_coin.usdc_amount,
